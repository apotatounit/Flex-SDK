Sensor Node Firmware – System Requirements Specification (Calibration & Testing)
...
9.2 Debug Behavior
	...
	•	The system shall continuously cycle through power and initialization sequences.
	•	The system shall repeat the following cycle with a 5-second delay between cycles:
	1.	Initialize sensor power.
	2.	Wait for a configurable wake-up delay.
	3.	Acquire sensor measurements.
	4.	Encode measurement values.
	5.	Suspend sensor power.
	6.	Wait 5 seconds.
	7.	Repeat from step 1.
	•	The system shall continuously read sensor outputs during each cycle.
	•	The system shall print sensor readings to the debug console at a configurable interval.
	•	The system shall compute and print ppm for windows of:
	•	5 seconds
	•	10 seconds
	•	20 seconds
	•	30 seconds
	•	The system shall attempt variable wake-up delays during calibration.
	•	The system shall allow observation of unstable sensor readings if sampled too early.
	•	The system shall measure and report the duration of:
	•	Minimum Modbus read cycle
	•	Minimum analog read cycle

9.3 Special Debug Behavior
	•	The system shall support reading once per power supply cycle upon receiving the first interrupt after supplying power.
