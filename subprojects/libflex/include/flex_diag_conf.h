...
/// Diagnostics and Configuration Subsystem
///@{
...
#define FLEX_DIAG_CONF_TABLE_BEGIN() \
  FLEX_DiagConfTableItem *diag_conf_table_get_(void) { \
    static FLEX_DiagConfTableItem table[FLEX_DIAG_CONF_ID_USER_MAX + 1] = {

/// End recording the diagnostic and configuration table
...
/// \param type If the table item is a configuration, diagnostic, or presistent diagnostic
...
typedef enum {
  FLEX_DIAG_CONF_TYPE_CONF,          ///< Configuration Type
  FLEX_DIAG_CONF_TYPE_DIAG,          ///< Diagnostic Type
  FLEX_DIAG_CONF_TYPE_PERSIST_DIAG,  ///< Persistent Diagnostic Type
} FLEX_DiagConfType;
